		...
		<div className="cartItem-con">
			<div className="cartItem">
				<div
					...
					style={{ backgroundImage: imageId ? `url('${DISH_SLAB_IMG_URL}${imageId}')` : `url('${defaultImg}')` }}
				/>
				{/* data */}
				<div className="item-data-con">
					...
					<div className="item-price-con">
						...
						<p className="selling-price" title={`${quantity} X ${((finalPrice || defaultPrice || price) / 100)}`}>
